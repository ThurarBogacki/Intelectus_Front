(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules__pnpm_09c120._.js", {
...
"[project]/node_modules/.pnpm/react-input-mask-next@3.0.0-alpha.12_react-dom@19.0.0_react@19.0.0__react@19.0.0/node_modules/react-input-mask-next/lib/react-input-mask.development.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
var React = __turbopack_require__("[project]/node_modules/.pnpm/next@15.1.7_react-dom@19.0.0_react@19.0.0__react@19.0.0/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var React__default = _interopDefault(React);
var reactDom = __turbopack_require__("[project]/node_modules/.pnpm/next@15.1.7_react-dom@19.0.0_react@19.0.0__react@19.0.0/node_modules/next/dist/compiled/react-dom/index.js [app-client] (ecmascript)");
var PropTypes = _interopDefault(__turbopack_require__("[project]/node_modules/.pnpm/prop-types@15.8.1/node_modules/prop-types/index.js [app-client] (ecmascript)"));
var invariant = _interopDefault(__turbopack_require__("[project]/node_modules/.pnpm/invariant@2.2.4/node_modules/invariant/browser.js [app-client] (ecmascript)"));
var warning = _interopDefault(__turbopack_require__("[project]/node_modules/.pnpm/warning@4.0.3/node_modules/warning/warning.js [app-client] (ecmascript)"));
...
function useInputElement(inputRef) {
    return React.useCallback({
        "useInputElement.useCallback": function() {
    ...
    }["useInputElement.useCallback"], [
        inputRef
    ]);
}
function useDeferLoop(callback) {
    var deferIdRef = React.useRef(null);
    var runLoop = React.useCallback({
        "useDeferLoop.useCallback[runLoop]": function() {
    ...
    }["useDeferLoop.useCallback[runLoop]"], [
        callback
    ]);
    var stopLoop = React.useCallback({
        "useDeferLoop.useCallback[stopLoop]": function() {
            cancelDefer(deferIdRef.current);
            deferIdRef.current = null;
        }
    }["useDeferLoop.useCallback[stopLoop]"], []);
    React.useEffect({
        "useDeferLoop.useEffect": function() {
            if (deferIdRef.current) {
                stopLoop();
                runLoop();
            }
        }
    }["useDeferLoop.useEffect"], [
        runLoop,
        stopLoop
    ]);
...
function useSelection(inputRef, isMasked) {
    ...
    var getSelection = React.useCallback({
        "useSelection.useCallback[getSelection]": function() {
            var input = getInputElement();
            return getInputSelection(input);
        }
    }["useSelection.useCallback[getSelection]"], [
        getInputElement
    ]);
    var getLastSelection = React.useCallback({
        "useSelection.useCallback[getLastSelection]": function() {
            return selectionRef.current;
        }
    }["useSelection.useCallback[getLastSelection]"], []);
    var setSelection = React.useCallback({
        "useSelection.useCallback[setSelection]": function(selection) {
    ...
    }["useSelection.useCallback[setSelection]"], [
        getInputElement,
        getSelection
    ]);
    var selectionLoop = React.useCallback({
        "useSelection.useCallback[selectionLoop]": function() {
            selectionRef.current = getSelection();
        }
    }["useSelection.useCallback[selectionLoop]"], [
        getSelection
    ]);
    var _useDeferLoop = useDeferLoop(selectionLoop), runSelectionLoop = _useDeferLoop[0], stopSelectionLoop = _useDeferLoop[1];
    React.useLayoutEffect({
        "useSelection.useLayoutEffect": function() {
            if (!isMasked) {
                return;
            }
            var input = getInputElement();
...
function useValue(inputRef, initialValue) {
    ...
    var getValue = React.useCallback({
        "useValue.useCallback[getValue]": function() {
            var input = getInputElement();
            return input.value;
        }
    }["useValue.useCallback[getValue]"], [
        getInputElement
    ]);
    var getLastValue = React.useCallback({
        "useValue.useCallback[getLastValue]": function() {
            return valueRef.current;
        }
    }["useValue.useCallback[getLastValue]"], []);
    var setValue = React.useCallback({
        "useValue.useCallback[setValue]": function(newValue) {
...
var InputMask = /*#__PURE__*/ React.forwardRef(function InputMask(props, forwardedRef) {
    ...
    React.useLayoutEffect({
        "InputMask.InputMask.useLayoutEffect": function() {
            if (!isMasked) {
                return;
            }
            var input = getInputElement();
    ...
    }["InputMask.InputMask.useLayoutEffect"]);
...
"[project]/node_modules/.pnpm/react-input-mask-next@3.0.0-alpha.12_react-dom@19.0.0_react@19.0.0__react@19.0.0/node_modules/react-input-mask-next/index.js [app-client] (ecmascript)": (function(__turbopack_context__) {

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, m: module, e: exports, t: __turbopack_require_real__ } = __turbopack_context__;
{
/* eslint-disable import/no-unresolved */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$1$2e$7_react$2d$dom$40$19$2e$0$2e$0_react$40$19$2e$0$2e$0_$5f$react$40$19$2e$0$2e$0$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/.pnpm/next@15.1.7_react-dom@19.0.0_react@19.0.0__react@19.0.0/node_modules/next/dist/build/polyfills/process.js [app-client] (ecmascript)");
if ("TURBOPACK compile-time falsy", 0) {
    "TURBOPACK unreachable";
} else {
    module.exports = __turbopack_require__("[project]/node_modules/.pnpm/react-input-mask-next@3.0.0-alpha.12_react-dom@19.0.0_react@19.0.0__react@19.0.0/node_modules/react-input-mask-next/lib/react-input-mask.development.js [app-client] (ecmascript)");
}
}}),
}]);

//# sourceMappingURL=node_modules__pnpm_09c120._.js.map